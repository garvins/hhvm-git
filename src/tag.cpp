	...
	int64_t force)
{
	...
	result = git_tag_create(oid_, HHVM_GIT2_V(repo_, repository), tag_name.c_str(), HHVM_GIT2_V(target_, object), HHVM_GIT2_V(tagger_, signature), message.c_str(), (int) force);
	return_value = (int64_t) result;
	return return_value;
}
	...
	const String& message)
{
	...
	result = git_tag_annotation_create(oid_, HHVM_GIT2_V(repo_, repository), tag_name.c_str(), HHVM_GIT2_V(target_, object), HHVM_GIT2_V(tagger_, signature), message.c_str());
	return_value = (int64_t) result;
	return return_value;
}
	...
	int64_t force)
{
	...
	result = git_tag_create_frombuffer(oid_, HHVM_GIT2_V(repo_, repository), buffer.c_str(), (int) force);
	return_value = (int64_t) result;
	return return_value;
}
	...
	int64_t force)
{
	...
	result = git_tag_create_lightweight(oid_, HHVM_GIT2_V(repo_, repository), tag_name.c_str(), HHVM_GIT2_V(target_, object), (int) force);
	return_value = (int64_t) result;
	return return_value;
}
